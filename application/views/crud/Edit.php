...
if($form_type=="page"){
  ...
  <div class=\"content-wrapper\">
    ...
    <section class=\"content-header\">
      ...
      <li class=\"#\">".ucwords(strtolower($this->template->label($table)))."</li>
...
foreach ($kolom as $klm) {
 ...
 if($tipe=="DATE"){ 
  ...
  $stringedit .=  "<div class=\"form-group\">
                      ...
                      <input type=\"date\" class=\"form-control\" id=\"form-".$klm."\" placeholder=\"Masukan ".$this->template->label($klm)."\" name=\"dt[".$klm."]\" value=\"<?= \$".$table."['".$klm."'] ?>\">
