...
class Backupdb extends My_Controller {
	...
	public function json()
	{
		...
		$this->datatables->select('log_backupdb.bdb_id, log_backupdb.bdb_file, log_backupdb.bdb_size, log_backupdb.bdb_created_at,log_backupdb.bdb_sizedisplay, log_backupdb.bdb_created_by,user.name');
