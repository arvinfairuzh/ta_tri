...
--
-- Struktur dari tabel `rekomendasi_crane`
--

CREATE TABLE IF NOT EXISTS `rekomendasi_crane` (
  `id` int(11) NOT NULL,
...
--
-- Struktur dari tabel `rekomendasi_operator`
--

CREATE TABLE IF NOT EXISTS `rekomendasi_operator` (
  `id` int(11) NOT NULL,
  `id_laporan` int(11) NOT NULL,
  `rekomendasi` text NOT NULL,
  `tindak_lanjut` text NOT NULL,
...
(0, 'Admin', 'ENABLE', '["1","38","39","16","37","36"]', '2018-10-12 17:03:59', '2020-06-23 17:19:20'),
(1, 'SE', 'ENABLE', '["1"]', '2018-10-24 10:29:54', '2020-02-21 15:15:39'),
(2, 'SPV K3', 'ENABLE', '["1"]', '2018-10-24 10:29:54', '2020-02-21 15:15:39'),
(3, 'Inspektor', 'ENABLE', '["1"]', '2018-10-24 10:29:54', '2020-02-21 15:15:39'),
(4, 'Gudang', 'ENABLE', '["1"]', '2018-10-24 10:29:54', '2020-02-21 15:15:39');
...
--
-- Indexes for table `rekomendasi_crane`
--
ALTER TABLE `rekomendasi_crane`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `rekomendasi_operator`
--
ALTER TABLE `rekomendasi_operator`
  ADD PRIMARY KEY (`id`);
